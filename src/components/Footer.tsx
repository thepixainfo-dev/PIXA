      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            ...
            <p className="text-white/40 leading-relaxed text-sm">
              Premium digital creative agency defining the future of brands through immersive strategy and technical precision.
            </p>
            <div className="flex items-center gap-4">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-brand-primary transition-all group"
                >
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Home", "About", "Portfolio", "Case Studies", "Blog", "Careers"].map((item) => (
                <li key={item}>
                  <Link to={`/${item.toLowerCase().replace(" ", "-")}`} className="text-white/60 hover:text-brand-primary transition-colors text-sm font-medium">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 mb-8 font-sans">Resources</h4>
            <ul className="space-y-4 font-medium">
              {["Terms", "Privacy", "Cookies", "Support", "Newsletter"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <div className="space-y-4">
               ...
               <p className="text-sm text-white/60">HSR Layout, Bangalore</p>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/30 text-sm text-center md:text-left">
            © {currentYear} PIXA Agency. All rights reserved.
          </p>
